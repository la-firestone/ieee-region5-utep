...
run(miner5)  # RUNNING FROM 'test_diagnostics'
# FEATURES: has 'test' button
...
run_ae(miner5)  # RUNNING FROM 'AeroSurveillance
# FEATURES: Drone can Fly and Scan in synchronous
